...
class Provinsi extends CI_Controller {
	...
	public function ajax_list()
	{
		...
		foreach ($list as $isi) {
			...
			$row[] = $isi->provinsi;			
			$row[] = "
						<a href=\"master/provinsi/delete?id=$isi->id_provinsi\" onclick=\"return confirm('Anda yakin?')\" class=\"btn btn-danger btn-sm\">hapus</a>                          
            <a href=\"master/provinsi/edit?id=$isi->id_provinsi\" class=\"btn btn-primary btn-sm\">ubah</a>";	
			$data[] = $row;
		}
