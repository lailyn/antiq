	...
	public function ajax_list()
	{
      ...
      if($isi->status=="draft"){      
      	...
      	$status = "<label class='badge badge-gradient-success'>Published</label>";
			...
			$row[] = "
						<a href=\"front/galeri/delete?id=$isi->id_galeri\" onclick=\"return confirm('Anda yakin?')\" class=\"btn btn-danger btn-sm\">hapus</a>                          
            <a href=\"front/galeri/edit?id=$isi->id_galeri\" class=\"btn btn-primary btn-sm\">ubah</a>";	
			$data[] = $row;
		}
