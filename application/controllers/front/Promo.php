	...
	public function ajax_list()
	{
      ...
      if($isi->status=="draft"){      
      	...
      	$status = "<label class='badge badge-gradient-success'>Published</label>";
			...
			$row[] = "
						<a href=\"front/promo/delete?id=$isi->id_promo\" onclick=\"return confirm('Anda yakin?')\" class=\"btn btn-danger btn-sm\">hapus</a>                          
            <a href=\"front/promo/edit?id=$isi->id_promo\" class=\"btn btn-primary btn-sm\">ubah</a>";	
			$data[] = $row;
		}
