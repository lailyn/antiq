  ...
  <div class="content-wrapper">    
      ...
      <?php                       
		...
		if($set=="insert"){
			if($mode == 'insert'){
				...
				$form = "update";              
				$vis  = "";
				$form_id = "<input type='hidden' name='id' value='$row->id_layanan_sub2_sub'>";              
			}
			?>
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-header">
                <h4 class="card-title"><a href="trans/layanan_sub2" class="btn btn-warning btn-sm"><i class="mdi mdi-eye"></i> View</a></h4>
            </div>
            <div class="card-body">
              <form action="trans/layanan_sub2/<?php echo $form ?>" method="POST" enctype="multipart/form-data" class="form-sample">                  
                <div class="row">
                  <div class="col-12">                
                    <div class="form-group row"> 
                      ...
                      <div class="col-sm-10">  
                        <?php echo $form_id ?>
                        <input type="text" <?php echo $read ?> value="<?php echo $tampil = ($row!='') ? $row->layanan_sub2 : "" ; ?>" name="layanan_sub2" placeholder="Layanan Sub 2" class="form-control" />
                      </div>                                          
                    </div>                                        
                    <div class="form-group row">                    
                      <label class="col-sm-2 col-form-label">Layanan Sub</label>
                      <div class="col-sm-4">                          
                        <select class="form-control" <?php echo $read2 ?> name="id_layanan_sub">
                          <?php $tampil = ($row!='') ? $row->id_layanan_sub : "" ; ?>                          
                          <option <?php if($tampil=="") echo 'selected' ?> value="">- choose -</option>
                          <?php                           
                          foreach ($dt_layanan->result() as $isi) {
                            $id_layanan_sub = ($row!='') ? $row->id_layanan_sub : "";
                            if($id_layanan_sub!='' && $id_layanan_sub==$isi->id_layanan_sub){
                             $se = "selected";
                            }else{
                              $se="";
                            }
                            echo "<option $se value='$isi->id_layanan_sub'>$isi->layanan_sub</option>";
                          }
                          ?>
                        </select>
                      </div>
    ...
    <div class="row">
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title"><a href="trans/layanan_sub2/add" class="btn btn-primary btn-sm"><i class="mdi mdi-plus"></i> Tambah</a></h4>
          </div>
          <div class="card-body">            
            <div class="box">                            
              <div class="table-responsive">
                <table id="layanan_sub2_dt" class="table" style="width:100%">
                  <thead>
                    <tr>
                      <th width="5%">No</th>
                      <th>Layanan Sub 2</th>
