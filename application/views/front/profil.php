        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-header">
                <h4 class="card-title"><a href="front/profil" class="btn btn-warning btn-sm"><i class="mdi mdi-eye"></i> View</a></h4>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12">                
                    <div class="form-group row">
                      ...
                      <div class="col-sm-5">  
                        <?php echo $form_id ?>                      
                        <input type="text" <?php echo $read ?> value="<?php echo $tampil = ($row!='') ? $row->profil : "" ; ?>" name="profil" placeholder="Profil" class="form-control" />
                      </div>                                          
                      ...
                      <div <?php echo $rt ?> class="col-sm-1">                          
                        <a href="assets/front/img/<?php echo $foto ?>" class="btn btn-danger btn-sm"><i class="mdi mdi-eye"></i></a>                        
                      </div>
                    </div>
