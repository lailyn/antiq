  ...
  <div class="content-wrapper">    
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-header">
                <h4 class="card-title"><a href="front/artikel" class="btn btn-warning btn-sm"><i class="mdi mdi-eye"></i> View</a></h4>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12">                
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-3">
                        <?php echo $form_id ?>
                        <select class="form-control" <?php echo $read2 ?> name="id_artikel_kategori">
                      ...
                      <div class="col-sm-1">
                        <a href="front/artikel/kategori" class="btn btn-success btn-sm"><i class="mdi mdi-plus"></i></a>
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">                        
                        <textarea id="textarea_plus2" name="preview" id="exampleTextarea1" class="form-control" rows="15">
                ...
                <div class="row">
                  <div class="col-12">                
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">         
                        <?php echo $form_id ?>               
                        <input type="text" <?php echo $read ?> value="<?php echo $tampil = ($row!='') ? $row->kategori : "" ; ?>" name="kategori" placeholder="Kategori" class="form-control" />
                      </div>         
                      <div class="col-sm-6">                      
    ...
    <div class="row">
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title"><a href="front/artikel/add" class="btn btn-primary btn-sm"><i class="mdi mdi-plus"></i> Tambah</a></h4>
          </div>
          <div class="card-body">            
            <div class="box">                            
              <div class="table-responsive">
